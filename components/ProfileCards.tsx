    ...
    <div className="bg-white rounded-xl border border-stone-200 overflow-hidden">
      ...
      {open && (
        <div className="px-4 pb-4 border-t border-stone-100 pt-3 space-y-4">
          {neededCertIds.size > 0 && (
            <div>
              <div className="text-xs font-semibold text-blue-600 uppercase tracking-wide mb-2">Needed</div>
              <div className="space-y-1.5">
                {[...neededCertIds].map((cid) => {
                  ...
                  return (
                    <div key={cid} className="flex items-center justify-between gap-3 text-sm bg-blue-50/60 border border-blue-100 rounded-lg px-3 py-2">
